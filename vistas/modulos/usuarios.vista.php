      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <button type="button" id="btnmodalnuevousuario" class="btn btn-primary btn-sm"
              data-toggle="modal" data-target="#modal-nuevo-usuario"><i class="fas fa-plus"></i> Nuevo
              Usuario</button>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table style="width: 100%;" id="tablausuario"
    ...
    <div class="modal-content">
      ...
      <div class="modal-body cuerpo-modal">
        <div class="input-group mb-3">
          ...
          <input id="usuarioCedula" type="text" class="form-control form-control-lg"
        ...
        <div class="input-group mb-3">
          ...
          <input id="usuarioUsuario" type="text" class="form-control form-control-lg"
        ...
        <div class="input-group mb-3 divusuarioPassword">
          ...
          <input id="usuarioPassword" type="password" class="form-control form-control-lg"
            placeholder="Ingresar Contraseña" readonly>
        </div>
        <div class="input-group mb-3">
          <div class="input-group-prepend">
            <span class="input-group-text"><i class="fas fa-user-circle"></i></span>
          </div>
          <input id="usuarioNombre" type="text" class="form-control form-control-lg"
        ...
        <div class="input-group mb-3">
          ...
          <input id="usuarioCelular" type="text" class="form-control form-control-lg"
        ...
        <div class="input-group mb-3">
          ...
          <input id="usuarioCorreo" type="email" class="form-control form-control-lg"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table style="width: 100%;" id="tablapermisosusuario"
          class="table table-borderless table-hover table-sm text-center">
          <thead>
            <tr>
              <th>Modulo</th>
              <th>Crear</th>
