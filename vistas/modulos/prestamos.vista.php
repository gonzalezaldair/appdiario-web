            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <button type="button" id="btnmodalnuevoprestamo" class="btn btn-primary btn-sm"
                            data-toggle="modal" data-target="#modal-nuevo-prestamo"><i class="fas fa-plus"></i> Nuevo
                            Prestamo</button>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table style="width: 100%;" id="tablaPrestamos"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="input-group mb-3 input-codigo">
                    ...
                    <input id="prestamoId" type="text" class="form-control form-control-lg"
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" id="prestamoCliente" class="form-control form-control-lg validarNumero"
                        placeholder="Ingresar Cedula o Telefono">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <textarea id="prestamoObservaciones" class="form-control"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="input-group mb-3">
                    ...
                    <input id="prestamoabonoid" type="text" class="form-control form-control-lg"
                        placeholder="Id Prestamo" readonly>
                </div>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                ...
                <div class="input-group mb-3">
                    ...
                    <input id="prestamosabonosaldo" type="text" class="form-control form-control-lg"
                        placeholder="Ingresar Saldo" readonly>
                </div>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-times"></i>
