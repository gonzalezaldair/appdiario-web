...
<head>
  ...
  <link rel="stylesheet" href="vistas/dist/css/masestilos.css?v=<?= filemtime("vistas/dist/css/masestilos.css"); ?>">
...
<body class="hold-transition sidebar-mini">
  ...
  <script src="vistas/js/rutas.js?v=<?= filemtime("vistas/js/rutas.js"); ?>"></script>
  <script src="vistas/js/forma-pago.js?v=<?= filemtime("vistas/js/forma-pago.js"); ?>"></script>
  <script src="vistas/js/cobros.js?v=<?= filemtime("vistas/js/cobros.js"); ?>"></script>
